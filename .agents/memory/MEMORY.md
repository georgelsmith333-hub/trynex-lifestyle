...
- [DesignStudio desktop drag fix](ds-desktop-drag-fix.md) — pointer:{touch:true} in useGesture drag breaks all mouse drag; use pointer:{buttons:[1]} instead. Wheel zoom pattern also documented.
