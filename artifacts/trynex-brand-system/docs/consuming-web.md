...
Read `artifacts/trynex-brand-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/trynex-brand-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/trynex-brand-system/styles.css";
```
...
`node_modules/@workspace/trynex-brand-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/trynex-brand-system/components/ui/button";
import { cn } from "@workspace/trynex-brand-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/trynex-brand-system/hooks/use-toast";
```
...
`@workspace/trynex-brand-system/components/ui/button`. Run the app's typecheck
