...
Read `artifacts/trynex-brand-system/docs/AGENTS.md` first. React Native does
...
`artifacts/trynex-brand-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/trynex-brand-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/trynex-brand-system/lib/native-theme";
import { useColors } from "@workspace/trynex-brand-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/trynex-brand-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/trynex-brand-system/components/native/badge";
import { Button } from "@workspace/trynex-brand-system/components/native/button";
import { Card } from "@workspace/trynex-brand-system/components/native/card";
```
...
Import and render
`@workspace/trynex-brand-system/components/native/button`, then run Expo
