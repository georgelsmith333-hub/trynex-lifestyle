...
export const DESIGN_SYSTEM = {
  ...
  description:
    'A warm, confident visual language for custom apparel, gifting, and the people who make both feel personal.',
} as const;

export const OVERVIEW_ENTRY: PreviewEntry = {
  id: 'overview',
  name: 'Overview',
  description: 'The visual foundations and product patterns that shape every TryNex surface.',
  Page: OverviewPage,
};
...
export const NAV_GROUPS: NavGroup[] = [
    ...
    entries: [
      {
        id: 'brand-language',
        name: 'Brand language',
        description: 'TryNex personality, trust cues, hierarchy, and usage guidance.',
        Page: BrandPage,
      },
    ],
  },
  ...
  },
  {
    ...
    entries: [
      {
        id: 'applied-storefront',
        name: 'Storefront patterns',
        description: 'A product card, delivery promise, and checkout-ready action hierarchy.',
        Page: AppliedExamplesPage,
      },
    ],
  },
  {
