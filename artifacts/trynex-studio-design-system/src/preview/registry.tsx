...
export const DESIGN_SYSTEM = {
  title: 'TryNex Studio Design System',
  description:
    'A photo-first TryNex system for custom product design: warm retail surfaces, clear editing controls, Bangladesh-green trust cues, and honest product mockups.',
} as const;
