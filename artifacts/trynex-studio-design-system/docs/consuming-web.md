# Consuming TryNex Studio Design System in web apps

Read `artifacts/trynex-studio-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/trynex-studio-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/trynex-studio-design-system/styles.css";
```
...
`node_modules/@workspace/trynex-studio-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/trynex-studio-design-system/components/ui/button";
import { cn } from "@workspace/trynex-studio-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/trynex-studio-design-system/hooks/use-toast";
```
...
`@workspace/trynex-studio-design-system/components/ui/button`. Run the app's typecheck
