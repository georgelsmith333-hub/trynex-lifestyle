# Migrating Expo UI to TryNex Studio Design System

Read `artifacts/trynex-studio-design-system/docs/AGENTS.md` and
`artifacts/trynex-studio-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/trynex-studio-design-system/lib/native-theme` and
  `@workspace/trynex-studio-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/trynex-studio-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/trynex-studio-design-system` and retains only
