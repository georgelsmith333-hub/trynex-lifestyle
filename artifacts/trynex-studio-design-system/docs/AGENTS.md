# TryNex Studio Design System design system
...
workspace package (`@workspace/trynex-studio-design-system`): other artifacts depend
...
- `docs/references/mockup-sources.md` — the authoritative product-photo contract
  for the TryNex studio. The existing reviewed mug, cap, and water-bottle photos
...
`@workspace/trynex-studio-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/trynex-studio-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/trynex-studio-design-system` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/trynex-studio-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/trynex-studio-design-system/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/trynex-studio-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/trynex-studio-design-system/docs/migrating-expo.md`
...
## TryNex studio composition rules
