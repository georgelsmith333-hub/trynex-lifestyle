# Consuming TryNex Studio Design System in Expo apps

Read `artifacts/trynex-studio-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/trynex-studio-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/trynex-studio-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/trynex-studio-design-system/lib/native-theme";
import { useColors } from "@workspace/trynex-studio-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/trynex-studio-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/trynex-studio-design-system/components/native/badge";
import { Button } from "@workspace/trynex-studio-design-system/components/native/button";
import { Card } from "@workspace/trynex-studio-design-system/components/native/card";
```
...
Import and render
`@workspace/trynex-studio-design-system/components/native/button`, then run Expo
