# Migrating web UI to TryNex Studio Design System

Read `artifacts/trynex-studio-design-system/docs/AGENTS.md` and
`artifacts/trynex-studio-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/trynex-studio-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/trynex-studio-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/trynex-studio-design-system/hooks/use-toast`
