...
export const DESIGN_SYSTEM = {
  title: 'TryNex Atelier Commerce',
  description:
    'A warm, premium visual language for realistic product creation, publishing, and shopping.',
} as const;
...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    entries: [
      {
        id: 'brand-principles',
        name: 'Atelier principles',
        description: 'The visual rules behind premium POD creation and commerce.',
        Page: OverviewPage,
      },
    ],
  },
  ...
  },
  {
    ...
    entries: [
      {
        id: 'applied-mockup-library',
        name: 'Mockup library',
        description: 'Side-aware product views and selected mockups for a listing.',
        Page: MockupLibraryPage,
      },
      {
        id: 'applied-listing-composer',
        name: 'Listing composer',
        description: 'Creator-facing title, description, SEO, and publish readiness.',
        Page: ListingComposerPage,
      },
      {
        id: 'applied-buyer-preview',
        name: 'Buyer preview',
        description: 'A confident product detail surface with trust and personalization.',
        Page: BuyerPreviewPage,
      },
    ],
  },
  {
