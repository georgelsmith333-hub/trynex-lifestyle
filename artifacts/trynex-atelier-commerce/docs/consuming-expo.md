# Consuming TryNex Atelier Commerce in Expo apps

Read `artifacts/trynex-atelier-commerce/docs/AGENTS.md` first. React Native does
...
`artifacts/trynex-atelier-commerce/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/trynex-atelier-commerce/tokens";
...
```tsx
import { nativeTheme } from "@workspace/trynex-atelier-commerce/lib/native-theme";
import { useColors } from "@workspace/trynex-atelier-commerce/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/trynex-atelier-commerce/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/trynex-atelier-commerce/components/native/badge";
import { Button } from "@workspace/trynex-atelier-commerce/components/native/button";
import { Card } from "@workspace/trynex-atelier-commerce/components/native/card";
```
...
Import and render
`@workspace/trynex-atelier-commerce/components/native/button`, then run Expo
