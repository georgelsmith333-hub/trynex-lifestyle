# Consuming TryNex Atelier Commerce in web apps

Read `artifacts/trynex-atelier-commerce/docs/AGENTS.md` first. This guide covers
...
`artifacts/trynex-atelier-commerce/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/trynex-atelier-commerce/styles.css";
```
...
`node_modules/@workspace/trynex-atelier-commerce/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/trynex-atelier-commerce/components/ui/button";
import { cn } from "@workspace/trynex-atelier-commerce/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/trynex-atelier-commerce/hooks/use-toast";
```
...
`@workspace/trynex-atelier-commerce/components/ui/button`. Run the app's typecheck
