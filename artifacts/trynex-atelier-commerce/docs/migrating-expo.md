# Migrating Expo UI to TryNex Atelier Commerce

Read `artifacts/trynex-atelier-commerce/docs/AGENTS.md` and
`artifacts/trynex-atelier-commerce/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/trynex-atelier-commerce/lib/native-theme` and
  `@workspace/trynex-atelier-commerce/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/trynex-atelier-commerce/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/trynex-atelier-commerce` and retains only
