# Migrating web UI to TryNex Atelier Commerce

Read `artifacts/trynex-atelier-commerce/docs/AGENTS.md` and
`artifacts/trynex-atelier-commerce/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/trynex-atelier-commerce/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/trynex-atelier-commerce/lib/utils`
- `@/hooks/use-toast` → `@workspace/trynex-atelier-commerce/hooks/use-toast`
