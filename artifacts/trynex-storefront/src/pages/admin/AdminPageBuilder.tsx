...
export default function AdminPageBuilder() {
  ...
  const onDragOver = (e: React.DragEvent, targetId: string) => {
    ...
    const draggingIdx = layout.findIndex(s => s.id === draggingId);
    const targetIdx = layout.findIndex(s => s.id === targetId);
    ...
    <AdminLayout>
      <div className="flex flex-col h-[calc(100vh-160px)]">
        ...
        <div className="flex gap-6 flex-1 min-h-0">
          ...
          <div className="w-64 bg-white border border-gray-200 rounded-2xl overflow-hidden flex flex-col">
          ...
          {/* Center - Layout */}
          <div className="flex-1 bg-gray-100/50 border border-gray-200 rounded-2xl p-6 overflow-y-auto">
              ...
              {layout.map((section, idx) => {
                ...
                return (
                  <div
                    ...
                    className={`
                      group relative flex items-center gap-4 p-4 bg-white border rounded-2xl transition-all cursor-move
                  ...
                  >
                    ...
                    <div className="w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center text-gray-500">
                      {libInfo?.icon ? <libInfo.icon className="w-5 h-5" /> : <Layout className="w-5 h-5" />}
                    </div>
                    <div className="flex-1">
                      <div className="text-sm font-bold text-gray-900">{libInfo?.name || section.type}</div>
                      <div className="text-[10px] text-gray-400 font-medium">Section ID: {section.id}</div>
                    </div>
          ...
          <div className="w-80 bg-white border border-gray-200 rounded-2xl overflow-hidden flex flex-col">
            <div className="p-4 border-b border-gray-100 bg-gray-50 font-bold text-xs uppercase tracking-widest text-gray-500">
              Section Settings
            </div>
