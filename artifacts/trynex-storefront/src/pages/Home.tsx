      ...
      <SEOHead
        ...
        jsonLd={[
          ...
          },
          {
            ...
            "potentialAction": {
              "@type": "SearchAction",
              "target": { "@type": "EntryPoint", "urlTemplate": "https://trynex-lifestyle-shop.pages.dev/products?search={search_term_string}" },
          ...
          <div className="flex gap-4 md:gap-6 overflow-x-auto pb-8 md:pb-0 md:grid md:grid-cols-3 lg:grid-cols-6 snap-x snap-mandatory no-scrollbar -mx-4 px-4 md:mx-0 md:px-0">
            {CATEGORIES.filter(cat => {
              ...
              const imageMap: Record<string, string> = {
                tshirt:      "/mockups/source-kit-v3/tshirt/white/front.png",
                longsleeve:  "/mockups/source-kit-v3/longsleeve/white/front.png",
                hoodie:      "/mockups/source-kit-v3/hoodie/white/front.png",
                cap:         "/mockups/source-kit-v3/cap/white/front.png",
                mug:         "/mockups/source-kit-v3/mug/white/front.png",
