...
function getProductFallback(product: Product): string {
  ...
  if (text.includes("mug") || text.includes("cup")) return "/mockups/normalized/mug-white-front.png";
  if (text.includes("hoodie") || text.includes("sweatshirt")) return "/mockups/normalized/hoodie-white-front.png";
  if (text.includes("bottle") || text.includes("flask") || text.includes("tumbler")) return "/mockups/normalized/waterbottle-white-front.png";
  if (text.includes("cap") || text.includes("hat")) return "/mockups/normalized/cap-white-front.png";
  if (text.includes("long sleeve") || text.includes("longsleeve") || text.includes("long-sleeve")) return "/mockups/normalized/longsleeve-white-front.png";
  return "/mockups/normalized/tshirt-white-front.png";
}
