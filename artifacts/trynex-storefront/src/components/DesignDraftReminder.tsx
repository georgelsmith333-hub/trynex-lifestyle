...
export function DesignDraftReminder() {
  ...
  const [draftInfo, setDraftInfo] = useState<{ productId: string; savedAt: number } | null>(null);
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (parsed?.version === 2 && Array.isArray(parsed.layers) && parsed.layers.length > 0) {
        setDraftInfo({ productId: parsed.productId, savedAt: parsed.savedAt });
        ...
        >
          ...
          <div className="p-4 flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-white/60 text-[11px] mt-0.5">Saved {since} — continue where you left off.</p>
            </div>
