# Migrating Expo UI to TryNex Lifestyle Design System

Read `artifacts/trynex-lifestyle-design-system/docs/AGENTS.md` and
`artifacts/trynex-lifestyle-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/trynex-lifestyle-design-system/lib/native-theme` and
  `@workspace/trynex-lifestyle-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/trynex-lifestyle-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/trynex-lifestyle-design-system` and retains only
