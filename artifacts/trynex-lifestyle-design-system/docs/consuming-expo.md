# Consuming TryNex Lifestyle Design System in Expo apps

Read `artifacts/trynex-lifestyle-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/trynex-lifestyle-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/trynex-lifestyle-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/trynex-lifestyle-design-system/lib/native-theme";
import { useColors } from "@workspace/trynex-lifestyle-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/trynex-lifestyle-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/trynex-lifestyle-design-system/components/native/badge";
import { Button } from "@workspace/trynex-lifestyle-design-system/components/native/button";
import { Card } from "@workspace/trynex-lifestyle-design-system/components/native/card";
```
...
Import and render
`@workspace/trynex-lifestyle-design-system/components/native/button`, then run Expo
