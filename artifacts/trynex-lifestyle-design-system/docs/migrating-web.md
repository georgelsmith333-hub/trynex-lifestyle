# Migrating web UI to TryNex Lifestyle Design System

Read `artifacts/trynex-lifestyle-design-system/docs/AGENTS.md` and
`artifacts/trynex-lifestyle-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/trynex-lifestyle-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/trynex-lifestyle-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/trynex-lifestyle-design-system/hooks/use-toast`
