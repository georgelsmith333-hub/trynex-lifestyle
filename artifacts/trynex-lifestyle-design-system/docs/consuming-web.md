# Consuming TryNex Lifestyle Design System in web apps

Read `artifacts/trynex-lifestyle-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/trynex-lifestyle-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/trynex-lifestyle-design-system/styles.css";
```
...
`node_modules/@workspace/trynex-lifestyle-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/trynex-lifestyle-design-system/components/ui/button";
import { cn } from "@workspace/trynex-lifestyle-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/trynex-lifestyle-design-system/hooks/use-toast";
```
...
`@workspace/trynex-lifestyle-design-system/components/ui/button`. Run the app's typecheck
