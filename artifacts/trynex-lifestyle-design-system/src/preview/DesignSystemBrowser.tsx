      ...
      <aside className="border-b bg-muted/20 md:sticky md:top-0 md:flex md:h-screen md:flex-col md:border-b-0 md:border-r">
        <div className="border-b px-5 py-5">
          <div className="flex items-center gap-2">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary font-sans text-lg font-bold text-primary-foreground">
              T
            </span>
            <div>
              <p className="font-sans text-sm font-bold">{DESIGN_SYSTEM.title}</p>
              <p className="mt-0.5 text-xs text-muted-foreground">Shared visual language</p>
            </div>
          </div>
        </div>
